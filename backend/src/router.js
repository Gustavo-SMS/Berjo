...
router.get('/customers/search', authenticateToken.authenticateToken, customerController.getCustomerByName)
...
router.get('/catalog-items', authenticateToken.authenticateToken, catalogController.getAll)
router.get('/catalog-items/type', authenticateToken.authenticateToken, catalogController.getTypes)
router.get('/catalog-items/search', authenticateToken.authenticateToken, catalogController.getWithFilter)
router.get('/catalog-items/collection/:collection', authenticateToken.authenticateToken, catalogController.getByCollection)
router.post('/catalog-items', authenticateToken.authenticateToken, catalogMiddleware.validateCatalogItemData, catalogController.createCatalogItem)
router.put('/catalog-items', authenticateToken.authenticateToken, catalogController.updateCatalogItem)
router.delete('/catalog-items/:id', authenticateToken.authenticateToken, catalogController.deleteCatalogItem)
